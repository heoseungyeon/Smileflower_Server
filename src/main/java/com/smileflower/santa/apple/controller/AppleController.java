...
public class AppleController {
    ...
    public AppleToken.Response appleLogin(@RequestBody AppleLoginRequest appleLoginRequest){
        ...
        System.out.println("appleLoginRequest.getIdentifyToken() = " + appleLoginRequest.getIdentifyToken());

        System.out.println("appleLoginRequest.getAuthorizationCode() = " + appleLoginRequest.getAuthorizationCode());
